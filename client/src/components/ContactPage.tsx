        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2 h-[400px] bg-gray-100 rounded-lg overflow-hidden relative border border-gray-200 shadow-sm">
             ...
             <div className="absolute top-4 left-4 bg-white p-4 shadow-md rounded max-w-[200px]">
                <h4 className="font-bold text-sm text-brand-blue mb-1">Abe Garage</h4>
                <p className="text-[10px] text-gray-500 leading-tight">Shiromeda, Addis Ababa, Ethiopia</p>
                <div className="flex items-center gap-1 mt-2 text-[10px] text-yellow-500">
                   ★★★★☆ <span className="text-blue-400 underline ml-1">124 reviews</span>
                </div>
             </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <h3 className="text-2xl font-bold text-brand-blue font-heading mb-8">Our Address</h3>
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-bold text-brand-blue font-heading mb-1">Address:</h4>
                  <p className="text-sm text-gray-500">Shiromeda, Addis Ababa, Ethiopia</p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-bold text-brand-blue font-heading mb-1">Email:</h4>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-bold text-brand-blue font-heading mb-1">Phone:</h4>
