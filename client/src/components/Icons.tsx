...
export const PlayButton = ({ small = false }: { small?: boolean }) => (
  <div
    className={`flex items-center justify-center rounded-full bg-brand-red text-white hover:bg-red-700 transition-colors cursor-pointer ${
