...
import { IconPerformance, IconTransmission, IconBrake, IconEngine, IconTyre, IconPaint } from './Icons';
...
const Services: React.FC<ServicesProps> = ({ onLearnMore }) => {
  const services: ServiceData[] = [
    ...
    { 
      ...
      prompt: "I need help with my transmission. What kind of services do you offer for gear issues?",
    ...
    { 
      ...
      prompt: "My brakes are making noise. How much for an inspection and repair?",
      shortDescription: "Comprehensive brake inspections and repairs for safety.",
    ...
    { 
      ...
      shortDescription: "Maximize traction and fuel economy with our tire services.",
    ...
    { 
      ...
      image: 'https://images.unsplash.com/photo-1746079074371-e28f14c76e37?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      prompt: "Can you give me a quote for removing dents and painting my car?",
      shortDescription: "Restore your car's aesthetic appeal to showroom quality.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <p className="mt-6 text-gray-500 text-sm max-w-3xl leading-relaxed">
            We offer a comprehensive range of car services using the latest technology and expert mechanics. Click on any service to learn more.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <ServiceCard 
              key={index} 
              service={service}
              onClick={() => onLearnMore(service.prompt || `I would like to know more about ${service.title}.`)}
            />
          ))}
        </div>
      </div>
